...
<head>
    ...
    <style>
        /* Struktur Flexbox Sticky Footer agar senada dengan Landing, Mahasiswa, & Jurusan */
        html, body {
            height: 100%;
            margin: 0;
        }
    ...
    <div class="content-grow">
        ...
        <div class="container my-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                <div>
                    <h1 class="main-title mb-1">Daftar Data Dosen</h1>
                    <p class="text-muted mb-0">Manajemen Data Pengajar SIAKAD ITBSS</p>
                </div>
                <div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-light text-dark border font-monospace">{{ $d->NIP }}</span></td>
                                <td><span class="badge bg-light text-dark border font-monospace">{{ $d->NIDN }}</span></td>
                                <td><span class="badge bg-light text-secondary border px-2 py-1">{{ $d->Pendidikan_Terakhir }}</span></td>
                                <td class="small text-muted">{{ $d->Jurusan_Id }}</td>
                                <td>
                                    <span class="d-block text-dark small fw-medium">{{ $d->Tempat_Lahir }}</span>
                                    <span class="d-block text-muted small" style="font-size: 0.8rem;">{{ $d->Tanggal_Lahir }}</span>
                                </td>
                                <td class="text-truncate small" style="max-width: 180px;" title="{{ $d->Alamat }}">{{ $d->Alamat }}</td>
                                <td class="text-muted small">{{ $d->created_at ? $d->created_at->format('d M Y') : '-' }}</td>
                                <td>
                            ...
                            @empty
                            <tr>
                                <td colspan="10" class="text-center text-muted italic py-4">
