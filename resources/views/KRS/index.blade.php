    ...
    <div class="content-grow">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
                  <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-3 mt-3 mt-lg-0">
                    <form class="d-flex" role="search" action="#" method="get">
                      <input class="form-control search-control" name="q" type="search" placeholder="Cari data KRS..." aria-label="Search">
        ...
        <div class="container my-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                <div>
                    <h1 class="main-title mb-1">Daftar Kartu Rencana Studi (KRS)</h1>
                    <p class="text-muted mb-0">Manajemen Rencana Kuliah Mahasiswa SIAKAD ITBSS</p>
                </div>
                <div>
                    <a href="{{ action([App\Http\Controllers\KRSController::class, 'create']) }}" class="btn btn-create shadow-sm">
                        + Tambah KRS Baru
                    </a>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted italic py-4">
                                    Belum ada data rencana studi (KRS) yang tersimpan.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
